...
## Sample Output
Below is a snapshot of the consolidated Excel report generated by the pipeline.

![Excel Report Preview](data/sample_outputs/report_20260125_preview.png)

**Highlights:**
- Yellow rows indicate records with expiry dates within 14 days
- Red text in the `comment` column highlights currency mismatches
- `user_comment` column contains a validation dropdown for manual review
